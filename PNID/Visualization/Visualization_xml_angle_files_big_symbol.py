...
xml을 파싱하여 각도와 좌표번호를 출력하는 코드(큰 심볼)
- 작은 심볼과 차이점: 현재까지 들어오는 좌표가  1/8되어있어서 8을 곱해서 가시화, 추후 수정 필요
...
def rotate_bbox(obj):
    ...
    point1 = [point1[0]*8, point1[1]*8]
    point2 = [point2[0]*8, point2[1]*8]
    point3 = [point3[0]*8, point3[1]*8]
    point4 = [point4[0]*8, point4[1]*8]
    
    return point1, point2, point3, point4
    

# XML 폴더 경로
xml_folder = r'../Xml/Txt2Xml_files_Big_symbol_result'

# 이미지 폴더 경로
image_folder = r'JPG_20230228'

# 결과 이미지를 저장할 폴더 경로
output_folder = r'Visualization_Txt2Xml_files_Big_symbol_result'
